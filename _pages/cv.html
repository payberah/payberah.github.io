...
Thesis: Live Streaming in P2P and Hybrid P2P-Cloud Environments for the Open Internet [<a href="files/download/thesis/phd_thesis.pdf" style="color:#64B2CB">pdf</a>] [<a href="files/download/thesis/phd_thesis_latex.tar.bz2" style="color:#64B2CB">latex</a>] [<a href="files/download/thesis/phd_bibtex.bib" style="color:#64B2CB">bibtex</a>] [<a href="files/download/thesis/phd_slides.pdf" style="color:#64B2CB">slides</a>] [<a href="http://youtu.be/1lBR6lhOxa0" style="color:#64B2CB">video</a>]<br>
...
Thesis: ForestCast for Peer-to-Peer Live Media Streaming [<a href="files/download/thesis/master_thesis.pdf" style="color:#64B2CB">pdf</a>] [<a href="files/download/thesis/master_bibtex.bib" style="color:#64B2CB">bibtex</a>] [<a href="files/download/thesis/master_slides.pdf" style="color:#64B2CB">slides</a>]<br>
...
Thesis: Auditing Intrusion Detection System using Mobile Agents [<a href="files/download/thesis/master_thesis_persian.pdf" style="color:#64B2CB">pdf</a>]<br>
